...
static xmmsv_t * xmms_collection_client_query_infos (xmms_coll_dag_t *dag, xmmsv_coll_t *coll, xmmsv_t *fetch, xmmsv_t *group, xmms_error_t *err);
                                    ...
                                    xmmsv_t *fetch, xmmsv_t *group, xmms_error_t *err)
{
	...
	unflattened = xmms_collection_client_query (dag, coll, fetch_spec, err);
