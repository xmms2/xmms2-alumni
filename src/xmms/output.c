...
static void xmms_playback_client_set_volume (xmms_output_t *output, const gchar *channel, gint32 volume, xmms_error_t *error);
static GTree *xmms_playback_client_get_volume (xmms_output_t *output, xmms_error_t *error);
...
static void
xmms_playback_client_set_volume (xmms_output_t *output, const gchar *channel,
...
static GTree *
xmms_playback_client_get_volume (xmms_output_t *output, xmms_error_t *error)
{
	GTree *ret;
