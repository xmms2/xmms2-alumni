...
const gchar *xmms_plugin_client_load (xmms_object_t *, const gchar *path, xmms_error_t *err);
const gchar *xmms_plugin_client_unload (xmms_object_t *, const gchar *name, xmms_error_t *err);
const gchar *xmms_plugin_client_reload (xmms_object_t *, const gchar *name, xmms_error_t *err);
