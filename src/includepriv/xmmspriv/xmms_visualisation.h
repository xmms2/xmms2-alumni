...
int32_t xmms_visualisation_init_shm (xmms_visualisation_t *vis, int32_t id, int32_t shmid, xmms_error_t *err);
...
void xmms_visualisation_register_output (xmms_output_t *output);
void xmms_visualisation_destroy (xmms_object_t *object);
