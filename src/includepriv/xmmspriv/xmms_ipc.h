...
void xmms_ipc_send_message (gint32 cli, xmms_ipc_msg_t *msg, xmms_error_t *err);
void xmms_ipc_send_broadcast (guint broadcastid, gint32 cli, xmmsv_t *arg, xmms_error_t *err);
