...
static xmmsc_sc_namespace_t *check_parent_namespace (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent);
...
/* from service.c */
void create_root_namespace (xmmsc_connection_t *c);
xmmsc_sc_interface_entity_t *locate_interface_entity (xmmsc_connection_t *c, xmmsv_t *path);
                         ...
                         xmmsv_t *value)
{
	...
	entity = locate_interface_entity (c, broadcast);
...
xmmsc_result_t * \
xmmsc_sc_##entity##_introspect (xmmsc_connection_t *c, int dest, \
                                xmmsv_t *entity) \
{ \
	x_check_conn (c, NULL); \
	x_api_error_if (!dest, "with 0 as destination client.", NULL); \
 ...
 */
xmmsc_result_t *
xmmsc_sc_namespace_get_constant (xmmsc_connection_t *c, int dest, xmmsv_t *nms,
                                 const char *key)
{
	xmmsv_t *keyfilter;
	xmmsc_result_t *res;
 ...
 */
xmmsc_result_t *
xmmsc_sc_get_docstring (xmmsc_connection_t *c, int dest, xmmsv_t *path)
{
	xmmsv_t *keyfilter;
	xmmsc_result_t *res;
 ...
 * @param c The connection structure.
 * @param parent The parent namespace, or NULL to nest the new namespace
...
xmmsc_sc_namespace_new (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent,
                        const char *name, const char *docstring)
{
	...
	parent = check_parent_namespace (c, parent);
 ...
 * Create a new method.
 * @param c The connection structure.
 * @param parent The parent namespace, or NULL to add the method
 ...
 */
bool
xmmsc_sc_method_new (xmmsc_connection_t *c,
                     ...
                     void *userdata)
{
	...
	x_api_error_if (positional_args &&
	                ...
	                "with non-list of positional arguments.", false);
	x_api_error_if (named_args &&
	                !xmmsv_is_type (named_args, XMMSV_TYPE_LIST),
	                "with non-list of named arguments.", false);
 ...
 * a method that accepts only positional arguments.
 *
 * \sa xmmsc_sc_method_new
 */
bool
xmmsc_sc_method_new_positional (xmmsc_connection_t *c,
                                xmmsc_sc_namespace_t *parent,
                                xmmsc_sc_method_t method,
                                const char *name, const char *docstring,
                                ...
                                void *userdata)
{
	return xmmsc_sc_method_new (c, parent, method, name, docstring,
	                            positional_args, NULL, va_positional,
	                            va_named, userdata);
}

/**
 * Convenience wrapper around xmmsc_sc_method_new to declare
 * a method that accepts only named arguments.
 *
 * \sa xmmsc_sc_method_new
 */
bool
xmmsc_sc_method_new_named (xmmsc_connection_t *c,
                           xmmsc_sc_namespace_t *parent,
                           xmmsc_sc_method_t method,
                           const char *name, const char *docstring,
                           xmmsv_t *named_args,
...
{
	return xmmsc_sc_method_new (c, parent, method, name, docstring,
	                            NULL, named_args, va_positional, va_named,
	                            userdata);
}
 ...
 */
bool
xmmsc_sc_method_new_noargs (xmmsc_connection_t *c,
                            xmmsc_sc_namespace_t *parent,
                            xmmsc_sc_method_t method,
                            const char *name, const char *docstring,
                            bool va_positional, bool va_named,
...
{
	return xmmsc_sc_method_new (c, parent, method, name, docstring,
	                            NULL, NULL, va_positional, va_named,
	                            userdata);
}
 ...
 */
bool
xmmsc_sc_broadcast_new (xmmsc_connection_t *c,
                        xmmsc_sc_namespace_t *parent,
                        const char *name, const char *docstring)
{
	xmmsc_sc_interface_entity_t *ifent;
...
/**
 * Check whether to use the root namespace (creating it if needed)
 * or another namespace as a parent for the *_new functions.
 */
static xmmsc_sc_namespace_t *
check_parent_namespace (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent)
{
	if (!parent) {
		if (!c->sc_root) {
			create_root_namespace (c);
		}

		parent = xmmsc_sc_interface_entity_get_namespace (c->sc_root);
	}
