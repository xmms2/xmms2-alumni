...
cmds commands[] = {
	...
	{ "plugin_load", "load a plugin into the server", cmd_plugin_load },
	{ "plugin_unload", "unload a plugin from the server", cmd_plugin_unload },
	{ "plugin_reload", "reload a plugin on the server", cmd_plugin_reload },
