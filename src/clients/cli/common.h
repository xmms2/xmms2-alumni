...
void print_hash (const void *key, xmms_value_t *value, void *udata);
void print_entry (const void *key, xmms_value_t *value, void *udata);
gint find_terminal_width ();
void format_pretty_list (xmmsc_connection_t *conn, GList *list);
gint val_has_key (xmms_value_t *val, const gchar *key);
gboolean coll_read_collname (gchar *str, gchar **name, gchar **namespace);
char *string_escape (const char *s);
xmms_value_t *make_value_stringlist (gchar **array, gint num);
