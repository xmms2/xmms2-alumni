...
void print_hash (const void *key, xmmsc_value_type_t type,
                 const void *value, void *udata);
void print_entry (const void *key, xmmsc_value_type_t type,
...
gint val_has_key (xmmsc_value_t *val, const gchar *key);
