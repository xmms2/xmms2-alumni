...
command_trie_match_type_t command_trie_complete (command_trie_t *trie, gchar ***input, gint *num, gboolean auto_complete, command_action_t **action, GList **completions);
