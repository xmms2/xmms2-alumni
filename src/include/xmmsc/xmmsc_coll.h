...
#define xmmsc_coll_remove_operand xmmsc_coll_remove_operand
...
#define xmmsc_coll_get_type xmmsc_coll_get_type
#define xmmsc_coll_get_idlist xmmsc_coll_get_idlist
