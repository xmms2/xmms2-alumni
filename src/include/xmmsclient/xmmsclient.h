...
bool xmmsc_sc_setup (xmmsc_connection_t *c);
xmmsc_result_t *xmmsc_sc_call (xmmsc_connection_t *c, int dest, xmmsv_t *method, xmmsv_t *pargs, xmmsv_t *nargs);

/* namespace */
xmmsc_sc_namespace_t *xmmsc_sc_namespace_new (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, const char *name, const char *docstring);
bool xmmsc_sc_namespace_add_constant (xmmsc_sc_namespace_t *nms, const char *key, xmmsv_t *value);
xmmsc_result_t *xmmsc_sc_namespace_introspect (xmmsc_connection_t *c, int dest, xmmsv_t *nms);
xmmsc_result_t *xmmsc_sc_namespace_get_constant (xmmsc_connection_t *c, int dest, xmmsv_t *nms, const char *key);
...
/* method */
bool xmmsc_sc_method_new (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, xmmsc_sc_method_t method, const char *name, const char *docstring, xmmsv_t *positional_args, xmmsv_t *named_args, bool va_positional, bool va_named, void *userdata);
bool xmmsc_sc_method_new_positional (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, xmmsc_sc_method_t method, const char *name, const char *docstring, xmmsv_t *positional_args, bool va_positional, bool va_named, void *userdata);
bool xmmsc_sc_method_new_named (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, xmmsc_sc_method_t method, const char *name, const char *docstring, xmmsv_t *named_args, bool va_positional, bool va_named, void *userdata);
bool xmmsc_sc_method_new_noargs (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, xmmsc_sc_method_t method, const char *name, const char *docstring, bool va_positional, bool va_named, void *userdata);
xmmsc_result_t *xmmsc_sc_method_introspect (xmmsc_connection_t *c, int dest, xmmsv_t *method);

/* broadcast */
bool xmmsc_sc_broadcast_new (xmmsc_connection_t *c, xmmsc_sc_namespace_t *parent, const char *name, const char *docstring);
xmmsc_result_t *xmmsc_sc_broadcast_introspect (xmmsc_connection_t *c, int dest, xmmsv_t *broadcast);

xmmsc_result_t *xmmsc_sc_get_docstring (xmmsc_connection_t *c, int dest, xmmsv_t *path);
