...
namespace XMMSQt
{
	...
	private:
		...
		bool put (const QVariant &, QDataStream *) const;
		bool put (const qint32 val, QDataStream *) const;
		bool put (const QString &, QDataStream *) const;
		bool put (const QByteArray &, QDataStream *) const;
		bool put (const QVariantList &, QDataStream *) const;
