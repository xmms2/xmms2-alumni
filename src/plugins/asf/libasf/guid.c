 ...
 *  Copyright (C) 2006-2008 Juho Vähä-Herttua
 *
...
static const guid_t asf_guid_header_extension =
{0x5FBF03B5, 0xA92E, 0x11CF, {0x8E, 0xE3, 0x00, 0xC0, 0x0C, 0x20, 0x53, 0x65}};

static const guid_t asf_guid_marker =
{0xF487CD01, 0xA951, 0x11CF, {0x8E, 0xE6, 0x00, 0xC0, 0x0C, 0x20, 0x53, 0x65}};

static const guid_t asf_guid_codec_list =
{0x86D15240, 0x311D, 0x11D0, {0xA3, 0xA4, 0x00, 0xA0, 0xC9, 0x03, 0x48, 0xF6}};

/* TODO */
static const guid_t asf_guid_stream_bitrate_properties =
{0x7BF875CE, 0x468D, 0x11D1, {0x8D, 0x82, 0x00, 0x60, 0x97, 0xC9, 0xA2, 0xB2}};

static const guid_t asf_guid_padding =
...
static const guid_t asf_guid_stream_type_video =
...
int
asf_guid_match(const guid_t *guid1, const guid_t *guid2)
{
...
guid_type_t
asf_guid_get_object_type(const guid_t *guid)
{
...
guid_type_t
asf_guid_get_stream_type(const guid_t *guid)
{
	guid_type_t ret = GUID_UNKNOWN;
...
guid_type_t
asf_guid_get_type(const guid_t *guid)
{
	guid_type_t ret;
